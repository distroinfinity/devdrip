...
const Section = ({ title, sub, t, children }) => (
  <div style={{ marginTop: 48 }}>
    ...
    {sub && (
      <p style={{ fontFamily: "'DM Sans'", fontSize: 13, color: t.inkTertiary, margin: "6px 0 0" }}>
        {sub}
      </p>
    )}
...
const Swatch = ({ color, name, hex, t, border }) => (
  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
    ...
    />
    <div>
      <div style={{ fontFamily: "'DM Sans'", fontSize: 12, fontWeight: 500, color: t.inkPrimary }}>
        {name}
      </div>
      <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: t.inkTertiary }}>
        {hex}
      </div>
    </div>
  </div>
        ...
        <div style={{ display: "flex", gap: 10, fontSize: 11 }}>
          {["[D]iscover", "[S]kip", "[M]ute"].map((a, i) => (
            <span
              ...
              style={{
                padding: "3px 8px",
                border: `1px solid ${i === 0 ? "#5C5C66" : "#2A2A2E"}`,
                color: i === 0 ? "#EDEDF0" : "#5C5C66",
                cursor: "pointer",
              }}
            >
              {a}
...
const DigestCard = ({ t }) => (
  <div
    style={{
      ...
      border: `1px solid ${t.ruleDefault}`,
      borderRadius: 8,
      padding: 20,
      position: "relative",
      overflow: "hidden",
  ...
  >
    ...
    <div style={{ position: "relative" }}>
      ...
      >
        <span style={{ fontFamily: "'DM Sans'", fontSize: 12, color: t.inkTertiary }}>
          Yesterday
        </span>
        <span
          style={{
      ...
      {[
        ...
        >
          ...
          <div>
            ...
            <div
              style={{ fontFamily: "'DM Sans'", fontSize: 11, color: t.inkTertiary, marginTop: 2 }}
            >
        ...
        {["Dismiss", "Show fewer", "Customize"].map((a, i) => (
          <span
            ...
            style={{
              ...
              cursor: "pointer",
              borderBottom: `1px solid ${i === 0 ? t.ruleStrong : "transparent"}`,
              paddingBottom: 1,
            }}
          >
            {a}
      ...
      >
        ...
        <div style={{ position: "relative", overflow: "hidden" }}>
          ...
          >
            ...
            >
              A monochrome design language for developers who earn while they wait. Precision
              through typography, not color.
            </p>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px 80px" }}>
          ...
          <Section
            t={t}
            title="Color System"
            sub="Pure monochrome with warm undertones. Status color is rare and tiny — like Nothing's red dot."
          >
            <div
              style={{
                display: "grid",
          ...
          <Section
            t={t}
            title="Typography"
            sub="Space Mono for headlines. DM Sans for body. JetBrains Mono for money."
          >
            <div
              style={{
                background: t.bgSurface,
            ...
            >
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                >
                  Card Title in DM Sans Semibold
                </div>
                <div
                  style={{
                    fontFamily: "'DM Sans'",
                ...
                >
                  Body text in DM Sans Regular. Developers opt in to see relevant content during
                  agent idle windows and earn USDC micropayments that offset their AI tool
                  subscriptions.
                </div>
                <div
                  style={{
              ...
              <div>
                ...
                >
                  DATA / JETBRAINS MONO — THE MONEY SIGNAL
                </div>
          ...
          <Section
            t={t}
            title="Buttons"
            sub="Maximum contrast. No colored buttons anywhere. Stripe approach."
          >
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10, alignItems: "center" }}>
              <button
                style={{
                  background: t.emPrimary,
                  color: t.inkInverse,
                  border: "none",
                  borderRadius: 8,
                  padding: "10px 22px",
              ...
              <button
                style={{
                  ...
                  fontWeight: 500,
                  cursor: "pointer",
                  borderBottom: `1px solid ${t.ruleDefault}`,
                  borderRadius: 0,
                }}
              >
                Learn more
          ...
          <Section
            t={t}
            title="Status & Badges"
            sub="Monochrome badges. Dot indicators instead of colored fills."
          >
          ...
          <Section
            t={t}
            title="Cards"
            sub="Standard, Data (dot-grid + ink border), Terminal (always dark / sharp), and Digest."
          >
            <div
              style={{
                display: "grid",
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: 8,
                  padding: 20,
                  borderLeft: `2px solid ${t.inkPrimary}`,
                  position: "relative",
                  overflow: "hidden",
                }}
              >
          ...
          <Section
            t={t}
            title="Data Table"
            sub="Bloomberg-style. Weight creates hierarchy — bold for earnings, regular for context."
          >
            <div
              style={{
                background: t.bgSurface,
              ...
              >
                ...
                <tbody>
                  {[
                    ...
                    <tr
                      key={i}
                      style={{ borderBottom: i < 4 ? `1px solid ${t.ruleSubtle}` : "none" }}
                    >
                      <td
                        style={{
                          fontFamily: "'DM Sans'",
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                          <div
                            style={{
                              ...
                              height: 5,
                              borderRadius: "50%",
                              background: r.active ? t.inkPrimary : t.inkFaint,
                            }}
                          />
                          <span
                            style={{
                              fontFamily: "'DM Sans'",
                              fontSize: 11,
                              color: r.active ? t.inkSecondary : t.inkTertiary,
                            }}
                          >
          ...
          <Section
            ...
            sub="The signature. Financial paper grain meets terminal phosphor."
          >
          ...
          <Section
            t={t}
            title="Progress"
            sub="Subscription offset tracking. Ink fill — no color needed."
          >
            <div
              style={{
                background: t.bgSurface,
            ...
            >
              ...
              <div
                style={{ height: 4, background: t.bgInset, borderRadius: 9999, overflow: "hidden" }}
              >
                <div
                  style={{
                    width: "73.6%",
          ...
          <Section t={t} title="Inputs" sub="Monospaced numbers. Clean borders.">
            <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "flex-end" }}>
              ...
              <div>
                ...
                >
                  <span
                    style={{ fontFamily: "'JetBrains Mono'", fontSize: 16, color: t.inkPrimary }}
                  >
                    4
                  </span>
                  <span style={{ fontFamily: "'DM Sans'", fontSize: 12, color: t.inkTertiary }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ fontFamily: "'DM Sans'", fontSize: 13, color: t.inkPrimary }}>
                  Audio
                </span>
              </div>
            </div>
          ...
          <Section
            ...
            sub="4px base. Sharp corners for terminal, soft for UI."
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              ...
              >
                ...
                {[
                  ...
                  >
                    <span
                      style={{ fontFamily: "'JetBrains Mono'", fontWeight: 700, opacity: 0.35 }}
                    >
                      +
                    </span>{" "}
                    {r}
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                Stripe processes trillions without green. Nothing ships hardware with a single red
                dot. Bloomberg moves billions on monochrome screens. We convey financial precision
                through typography, weight, and motion — with Electric Indigo at 8 surgical
                touchpoints. The{" "}
          ...
          >
            <span style={{ fontFamily: "'Space Mono'", fontSize: 12, color: t.inkTertiary }}>
              dev drip v1.1
            </span>
            <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: t.inkFaint }}>
