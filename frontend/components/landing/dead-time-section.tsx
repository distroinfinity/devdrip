...
const DATA_POINTS = [
  ...
  { label: "as agents improve", value: "growing" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-16 items-center">
          ...
          <div>
            <BlurFade inView delay={0}>
              ...
              <h2 className="font-display text-h2 md:text-h1 font-bold text-[var(--ink-primary)] tracking-[-0.02em] mb-6">
                The Dead Time
              </h2>
            </BlurFade>
            ...
            <BlurFade inView delay={0.1}>
              <div className="max-w-content space-y-4 mb-10">
                ...
                <p className="font-body text-body text-[var(--ink-primary)] leading-[1.6]">
