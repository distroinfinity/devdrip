  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="font-body text-[14px] font-medium mt-2 mb-3" style={{ color: tc.text }}>
          {QUESTION.text}
        </p>
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{
                    color: revealed && isCorrectOption ? "var(--accent-color)" : tc.textTertiary,
                  }}
                >
                  {opt.key}
                </span>
                <span className="font-body text-[12px]" style={{ color: tc.text }}>
                  {opt.text}
                </span>
              </button>
            )
        ...
        <AnimatePresence>
          {revealed && (
            ...
            >
              ...
              >
                {isCorrect ? "Correct! +$0.10" : `The answer was ${QUESTION.correctKey}`}
              </span>
              <button
                type="button"
                onClick={handleReset}
